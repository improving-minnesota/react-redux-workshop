...
/* WEBPACK VAR INJECTION */(function (process) {
          ...
          function installDeps() {
            ...
            _console2.default.log(`ðŸ“¦  Installing dependencies via ${installer} ${args.join(' ')}`);
            ...
            function spawnInstall(cwd) {
              return new Promise(function (resolve, reject) {
                _console2.default.log(`ðŸ”‘  starting install in ${cwd}`);
                ...
                function onExit(code) {
                  if (code === 0) {
                    _console2.default.log(`ðŸŽ‰  finished installing dependencies in "${cwd}"`);
                    resolve();
                  } else {
                    _console2.default.error(`ðŸ’€  error installing dependencies in "${cwd}"`);
                    reject(cwd);
                  }
                }
              });
